...
:: Sign the app 
"%CUBEPROGRAMMER_TOOL_PATH%\STM32_SigningTool_CLI.exe" -s -bin "%BIN_DIR%STM32N6570-DK_FSBL.bin" -nk -of 0x80000000 -t fsbl -o "%OUT_DIR%STM32N6570-DK_FSBL-trusted.bin" -hv 2.3 -align -dump "%OUT_DIR%STM32N6570-DK_FSBL-trusted.bin"
